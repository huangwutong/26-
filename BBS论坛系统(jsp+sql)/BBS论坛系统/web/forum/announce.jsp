...
%>
		...
		<form action="SaveAnnounce.jsp?forumID=<%=forumID%>" method="POST" onSubmit="return check(this)" name="frmAnnounce">
		...
		<INPUT TYPE="hidden" name="forumType" value="<%=response.encodeURL(theForum.getForumType())%>">
		<INPUT TYPE="hidden" name="skin" value="">
		        ...
		        <tr bgcolor="<%=tableBodyColor%>">
		          ...
		          <td width="86%">
		<%for(i=1;i<10;i++){%>
			<input type="radio" value="face<%=i%>" name="expression" <%if (i==1) out.println ("checked");%>><img src="face/face<%=i%>.gif" WIDTH="15" HEIGHT="15">&nbsp;&nbsp;
		<%}%>
		<br>
		<%for(i=10;i<19;i++)%>

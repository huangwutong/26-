...
public class OLUser{
	...
	public static String getUserBrowser(String browser){
		...
		if (browser.indexOf("NetCaptor 6.5.0")>=0)
			userBrowser="浏 览 器：NetCaptor 6.5.0";
		else if (browser.indexOf("MyIe 3.1")>=0)
			userBrowser="浏 览 器：MyIe 3.1";
		else if (browser.indexOf("NetCaptor 6.5.0RC1")>=0)
			userBrowser="浏 览 器：NetCaptor 6.5.0RC1";
		else if (browser.indexOf("NetCaptor 6.5.PB1")>=0)
			userBrowser="浏 览 器：NetCaptor 6.5.PB1";
		else if (browser.indexOf("MSIE 5.5")>=0)
			userBrowser="浏 览 器：Internet Explorer 5.5";
		else if (browser.indexOf("MSIE 6.0")>=0)
			userBrowser="浏 览 器：Internet Explorer 6.0";
		else if (browser.indexOf("MSIE 6.0b")>=0)
			userBrowser="浏 览 器：Internet Explorer 6.0b";
		else if (browser.indexOf("MSIE 5.01")>=0)
			userBrowser="浏 览 器：Internet Explorer 5.01";
		else if (browser.indexOf("MSIE 5.0")>=0)
			userBrowser="浏 览 器：Internet Explorer 5.00";
		else if (browser.indexOf("MSIE 4.0")>=0)
			userBrowser="浏 览 器：Internet Explorer 4.01";
		else
			userBrowser="浏 览 器：未知";
		return userBrowser;

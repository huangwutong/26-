...
function updateClient()
{
	...
	if(ids != "")
	{
		search.action = "cToa?cleintids="+ids+"&i="+j+"&s=1";
		search.method = "post";
...
<form name="search" method="post" action="scarchc">
		...
		<span id=os1><select name="district"><option value="">请选择...</option></select></span>
		  行业
			...
			<c:forEach items="${applicationScope.industry}" var="industr">
 			...
 			<a href="javascript:updateClient()" class="pagenum">收藏</a>&nbsp;
 			<span id="searcherror"/>
    </td>
  </tr>
  <tr>
...
<c:forEach items="${requestScope.search}" var="company">
      <tr class="contentListTd">
        ...
        <td><a href="cinfo?companyid=${company.companyid}&${requestScope.page}"><img src="images/btn_01.gif" width="15" height="15" border="0" /></a></td>
      </tr>
</c:forEach>
	<tr class="contentListTd">

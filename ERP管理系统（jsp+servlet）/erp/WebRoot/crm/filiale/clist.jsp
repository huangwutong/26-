...
function updateClient()
{
	...
	form1.action = "fdelectcompany?cleintids="+ids+"&i="+j; 
	if(ids != "")
	{
...
<table width="100%" border="0" cellpadding="8" cellspacing="1" class="contentArea">
  <tr>
    ...
    操作：<a href="javascript:updateClient()" class="pagenum">删除</a>&nbsp;&nbsp;&nbsp;&nbsp;${requestScope.csize }</c:if></td>
...
<c:forEach items="${requestScope.pageRows}" var="company">
      <tr class="contentListTd">
        ...
        <td><a href="finfo?companyid=${company.companyid}&c=1"><img src="images/btn_01.gif" width="15" height="15" border="0" /></a></td>
      </tr>
</c:forEach>
      <tr class="contentListTd">

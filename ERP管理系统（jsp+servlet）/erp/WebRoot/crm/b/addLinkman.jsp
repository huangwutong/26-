...
function check()
{
	...
	document.form1.submit();
		...
		<form name="form1" method="post" action="addLinkmanb?companyid=${sessionScope.info.companyid}">
		<table width="100%" border="0" cellpadding="8" cellspacing="1"
			class="contentArea">
			<tr>
				<td class="attachMenu">
					操作：
					<a href="select" class="pagenum" >返回B库</a>&nbsp;&nbsp;&nbsp;
					<a href="turn?type=bi" class="pagenum" >返回客户信息</a>
				</td>
			</tr>
			<tr>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="8"
						class="contentListTable2">
							...
							<tr>
								...
								<td class="contentListTd">
									<input name="job" type="text" id="job" value="" size="20" maxlength="30" />[可以为空,最多输入30个字] 
								</td>
							</tr>
							<tr>

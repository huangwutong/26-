...
<form name="form1" method="post" action="addVisitb?linkmanid=${requestScope.linkman}">
<table width="100%" border="0" cellpadding="8" cellspacing="1" class="contentArea">
  <tr>
    <td class="attachMenu">操作：<a href="select" class="pagenum" >返回B库</a>&nbsp;&nbsp;&nbsp;<a href="turn?type=bi" class="pagenum" >返回客户信息</a></td>
  </tr>
  <tr>
    <td class="contentList"><table width="100%" border="0" cellspacing="1" cellpadding="8" class="contentListTable2">
          ...
          <td width="84%" class="contentListTd">
			<input name="type" id="type" type="radio" value="A" />A级
			<input name="type" id="type" type="radio" value="B" />B级
			<input name="type" id="type" type="radio" value="C" />C级
			<input name="type" id="type" type="radio" value="D" />D级
			<input name="type" id="type" type="radio" value="E" />E级<span id="typeerror"></span>
			</td>
        </tr>
        <tr>
          ...
          <td width="84%" class="contentListTd">
			...
			<input name="visittype" id="visittype" type="radio" value="A" />电话
			<input name="visittype" id="visittype" type="radio" value="B" />上门<span id="visittypeerror" />
		  </td>
        </tr>
        <tr>

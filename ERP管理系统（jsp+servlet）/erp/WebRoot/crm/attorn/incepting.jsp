...
function accept()
{
	...
	ids = ids.substr(0,ids.length - 1);
	form1.action = "incept?cleintids="+ids; 
	if(ids != "")
	{
		document.form1.submit();
	}
...
<table width="100%" border="0" cellpadding="8" cellspacing="1" class="contentArea">
  <tr>
    <td class="searchBar"><a href="javascript:accept();" class="pagenum">接收</a>&nbsp;&nbsp;&nbsp;<a href="javascript:cencelattorn();" class="pagenum">不接收</a></td>
  </tr>
  <tr>
...
<div id="helpContent">
  ...
  <div class="Content">接收客户之前不要忘了对你的同事说声谢谢！</div>
</div>
</body>
</html>
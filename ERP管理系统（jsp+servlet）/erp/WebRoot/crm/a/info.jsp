...
function getResult()
{
	...
	<body onload="info();">
		...
		<table width="100%" border="0" cellpadding="8" cellspacing="1"
			...
			<tr>
				<td class="attachMenu">
					<strong>基本资料</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;一共拜访了这个客户:${sessionScope.info.visitcount
					}次
				</td>
			</tr>
			<tr>
				<td class="contentList">
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="8"
							...
							<tr>
								...
								<td width="84%" class="contentListTd">
									&nbsp;${sessionScope.info.namekeywords}
								</td>
							</tr>
							<tr>
								...
								<td class="contentListTd">
									&nbsp;${sessionScope.info.nameparticular}
								</td>
							</tr>
							<tr>
								<td class="contentListTdColName">
								...
								<td class="contentListTd">
									&nbsp;${sessionScope.info.companyaddress}
								</td>
							</tr>
							<tr>
								<td class="contentListTdColName">
							...
							<tr>
								...
								<td class="contentListTd">
									&nbsp;${sessionScope.info.district.district }
								</td>
							</tr>
							<tr>
								<td class="contentListTdColName">
							...
							<tr>
								...
								<td class="contentListTd">
									&nbsp;${sessionScope.info.industry.industry }
								</td>
							</tr>
							<tr>
								<td class="contentListTdColName">
								...
								<td class="contentListTd">
									&nbsp;${sessionScope.info.companynarrate}
								</td>
							</tr>
							<tr>
								<td class="contentListTd contentListTdAlign" colspan="2">
									...
									<c:if test="${requestScope.page!=null}">
										<c:if test="${requestScope.page!=''}">
										<a href="searchab?${requestScope.page }" class="pagenum">返回</a>&nbsp;&nbsp;&nbsp;
										</c:if>
							</c:if>
									<c:if test="${requestScope.size!=null}">
									<c:if test="${requestScope.size!=''}">
										<a href="selectA?page=${requestScope.size}" class="pagenum">返回A库</a>&nbsp;&nbsp;&nbsp;
										</c:if>
							</c:if>
									<a href="turn?type=al" class="pagenum">添加联系人</a>
									<a href="turn?type=alav" class="pagenum">添加联系人与拜访</a>
									<a href="turn?type=an" class="pagenum">添加公司简介</a>
					...
					<div id="update">
						<form name="addCompany" method="post" action="update?id=${sessionScope.info.companyid}&size=${requestScope.size}&page=${requestScope.page }">
							<table width="100%" border="0" cellspacing="1" cellpadding="8"
								class="contentListTable2">
								<tr>
									<td width="16%" class="contentListTdColName">
		...
		<table width="100%" border="0" cellpadding="8" cellspacing="1"
			...
			<c:forEach items="${sessionScope.info.linkmans}" var="linkman">
				<tr>
					<td class="contentList">
						<table width="100%" border="0" cellspacing="1" cellpadding="8"
							class="contentListTable2 spaceBottom">
							<tr>
								<td width="50" class="contentListTdColName">
									姓名:
								</td>
								<td width="14%" class="contentListTdColName3">
									&nbsp;${linkman.linkmanname }
								</td>
								<td width="50" class="contentListTdColName">
									职位:
								</td>
								<td width="12%" class="contentListTdColName3">
									&nbsp;${linkman.job }
								</td>
								<td width="50" class="contentListTdColName">
									电话:
								...
								<td width="12%" class="contentListTdColName3">
									&nbsp;${linkman.linkmanemail }
								</td>
								<td width="50" class="contentListTdColName">
									手机:
								</td>
								<td class="contentListTdColName3">
									&nbsp;${linkman.linkmanmoblie }
								</td>
							</tr>
							<c:forEach items="${linkman.visits}" var="visit">
								<tr>
									<td class="contentListTd" colspan="10">
										[${visit.visittime }]-[
							...
							<td class="contentListTd contentListTdAlign" colspan="10">
								<a href="turn?type=av&linkmanid=${linkman.linkmanid }"
									class="pagenum">添加拜访记录</a>&nbsp;
							</td>
						</table>
					</td>
				</tr>

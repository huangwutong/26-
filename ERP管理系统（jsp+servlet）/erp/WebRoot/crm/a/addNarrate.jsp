...
<form name="form1" method="post" action="addNarrate?companyid=${sessionScope.info.companyid}">
<table width="100%" border="0" cellpadding="8" cellspacing="1" class="contentArea">
  <tr>
    <td class="attachMenu">操作：
    	<a href="selectA" class="pagenum" >返回A库</a>&nbsp;&nbsp;&nbsp;<a href="turn?type=ai" class="pagenum" >返回客户信息</a>
    </td>
  </tr>
  <tr>

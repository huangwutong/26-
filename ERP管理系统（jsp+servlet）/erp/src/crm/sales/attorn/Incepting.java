...
public class Incepting extends HttpServlet
{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		RequestDispatcher rd = request.getRequestDispatcher("/crm/attorn/incepting.jsp");
		if (cm.getConnection())
		{
			try
			{
				Personnel user = (Personnel) request.getSession().getAttribute("user");
				String sql = "select * from company where accepterid=" + user.getPersonnelid();

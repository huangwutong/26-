...
public class AddLinkman extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		linkman.insert();
		linkman.getnew();
		request.setAttribute("success", "添加联系人成功!<a href='infoA?companyid="+compageid+"' class='pagenum' >返回</a>&nbsp;&nbsp;&nbsp;<a href='turn?type=av&linkmanid="+linkman.getLinkmanid()+"' class='pagenum'>添加拜访记录</a>");

...
public class AddNarrate extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		String sql = "update company set companynarrate = companynarrate + '<br/>["+request.getSession().getAttribute("date")+"]:"+request.getParameter("narrate")+"--"+user.getRealname()+"-"+user.getDept().getDeptname()+"' where companyid = "+compageid;
		...
		if (cm.getConnection())
		{
			try
			{
				...
				request.setAttribute("success", "公司简介添加成功!<a href='infoA?companyid="+compageid+"' class='pagenum' >返回</a>");

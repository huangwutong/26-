			...
			try
			{
				if (ids.length() > 1)
				{
					...
					for (String temp:strs)
					{
						...
						{
							sql = "update company set lastPersonnel = personnelid,companystate = 'C',companytype='A',personnelid=null,accepterid=null,indate=null where companyid in (" + ids + ")";
							...
							request.setAttribute("success", "客户已删除成功!<a href='select' class='pagenum' >返回</a>");

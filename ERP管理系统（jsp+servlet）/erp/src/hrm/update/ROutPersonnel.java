...
public class ROutPersonnel extends HttpServlet
{
	...
	{
		String sql = "update personnel set username=null,password=null where personnelid in ("+request.getParameter("cleintids")+")";

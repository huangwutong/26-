...
if(test_testtype.equals("2"))
    //单元测试
    sql="update test set status=2 where id in ("+sql+")";
else if(test_testtype.equals("3"))
    //模拟测试
    sql="update mn_test set status=2 where id in ("+sql+")";
else if(test_testtype.equals("1"))
    //模拟测试
    sql="update test set status=4 where id in ("+sql+")";

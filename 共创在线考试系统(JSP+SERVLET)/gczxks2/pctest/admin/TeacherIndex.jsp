...
<form name="form1" action="success.htm">
  ...
  <table width="95%" border="0" cellspacing="2" cellpadding="0" align="center">
    <tr> 
      <td height="71" align="center" valign="middle" class="titlefont1 style3">教师信息维护</td>
    </tr>
    <tr> 
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="3" align="center" >
    <tr> 
      ...
      <td height="44" align="right" ><input type="button" class="button_xh1" onClick="callSysWithScroll('TeacherAdd.jsp',600,500)" value="添加教师"></td>
    </tr>
  </table>
  <br>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="3" align="center" 　bgcolor="#000000">
    <tr> 
      ...
      <td width="23%" align="center" class="tdtopline"><strong>维护日期</strong></td>
      <td width="19%" align="center" class="tdtopline"><strong>备注</strong></td>
    </tr>
...
rs = webdb.query("select * from teacher order by id");
...
<tr onClick="callSysWithScroll('TeacherMod.jsp?iID=<%=webdb.getRsStr(rs,"id")%>',600,500)" bgcolor=ffffff align="center"  id="b<%=i%>" onMouseOver="setColor('b<%=i%>.bgColor=\'#99CCFF\'')" onMouseOut="setColor('b<%=i%>.bgColor=\'ffffff\'')">

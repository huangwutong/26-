...
<body>
<form action="../servlet/AddAdmin" method="post" name="formemp" target="_self" id="formemp" onSubmit="return checkdata(this)">
  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr> 
      <td align="center" class="titlefont1">添加管理员资料</td>
    </tr>
    <tr>
  ...
  <table width="90%" border="0" align="center" cellpadding="3" cellspacing="0" class="tabout">
    <tr> 
	  ...
	  <input name="syspower" type="hidden" value="1">
      填写信息</th>
    </tr>
    <tr> 
    ...
    <tr > 
      ...
      <td class="tdulleft"><table width="281" border="0">
        <tr>
          <td width="192">
		  <input class=inputtext id=sel1 maxlength=10 size=10 name=daBrith><input name="按钮" type=button class=unnamed1 onClick="return showCalendar('sel1','%Y-%m-%d');" value=...></td>
          <td width="79">            </td>
        </tr>
      </table></td>
    </tr>
    ...
    <tr  > 
      ...
      <td class="tdulleft">        <table width="222" border="0">
          <tr>
            <td><input name=daWorkDate class=inputtext id=sel2 size=10 maxlength=10><input type=button class=unnamed1 onClick="return showCalendar('sel2','%Y-%m-%d');" value=...></td>
            <td>&nbsp;</td>
          </tr>
        </table> </td>
    </tr>
  ...
  <table width="240" border="0" align="center" cellpadding="5" cellspacing="4">
    <tr>
    <td><input  type="submit" class="button_xh" value="2确认" ></td>

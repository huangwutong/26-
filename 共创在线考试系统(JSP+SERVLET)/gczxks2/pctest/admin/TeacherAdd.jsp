...
<body>
<form action="../servlet/TeacherAdd" method="post" name="formemp" target="_self" id="formemp" onSubmit="return checkdata(this)">
  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr> 
      <td align="center" class="titlefont1">添加教师资料</td>
    </tr>
    <tr>
  ...
  <table width="90%" border="0" align="center" cellpadding="3" cellspacing="0" class="tabout">
    <tr> 
      ...
      <th width="90%" class="thlist"><input name="t" type="hidden" value="teacher">
	  <input name="a" type="hidden" value="add">
	  
      填写信息</th>
    </tr>
    <tr> 
      <td class="tdulright"><span class="p2"><FONT color=#d11b00>*</FONT> </span>教师代码：</td>
      <td class="tdulleft"><input name="vcUserNo" type="text" class="inputtext" id="em_pcode" maxlength="15">      </td>
    </tr>
	<tr class="trcolor"> 
      <td class="tdulright"><span class="p2"><FONT color=#d11b00>*</FONT> </span>教师密码：</td>
    ...
    <tr > 
      ...
      <td class="tdulleft"><table width="281" border="0">
        <tr>
          <td>
<input name=daBrith class=inputtext id=sel1 size=10 maxlength=10><input name="按钮" type=button class=unnamed1 onClick="return showCalendar('sel1','%Y-%m-%d');" value=...></td>
          <td width="79">            </td>
        </tr>
      </table></td>
    </tr>
    ...
    <tr > 
      ...
      <td class="tdulleft"><table width="281" border="0">
        <tr>
          <td>
<input name=daWorkDate class=inputtext id=sel2 size=10 maxlength=10><input name="按钮" type=button class=unnamed1 onClick="return showCalendar('sel2','%Y-%m-%d');" value=...></td>
          <td width="79">            </td>
        </tr>
      </table></td>
    </tr>

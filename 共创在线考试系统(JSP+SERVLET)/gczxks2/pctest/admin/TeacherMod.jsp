...
java.sql.ResultSet rs = webdb.query("select * from teacher where id = '"+iID+"'");
if(rs.next()){
...
<body>
<form action="../servlet/TeacherMod" method="post" name="formemp" target="_self" id="formemp" onSubmit="return checkdata(this)">
  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr> 
      <td align="center" class="titlefont1">教师资料</td>
    </tr>
    <tr>
  ...
  <table width="90%" border="0" align="center" cellpadding="3" cellspacing="0" class="tabout">
    <tr> 
	  ...
	  <input name="a" type="hidden" value="mod"><input name="id" type="hidden" value="<%=id%>">
      填写信息</th>
    </tr>
    <tr> 
...
<input name=daWorkDate class=inputtext id=sel2 value="<%=daWorkDate%>" size=10 maxlength=10><input name="按钮" type=button class=unnamed1 onClick="return showCalendar('sel2','%Y-%m-%d');" value=...></td>
  ...
  <table width="240" border="0" align="center" cellpadding="5" cellspacing="4">
    ...
    <td><input  type=reset class="button_xh" onClick="del('../servlet/TeacherDel?id=<%=id%>')" value="删　除"></td>
    </tr>
</table>

...
test.mnTestID=request.getParameter("mnID");

if(debug) out.print("<br>testid="+test.id+
				"<br>mntestID="+test.mnTestID);
if(test.id==null || test.mnTestID==null)
...
function gotestpaper(){
    ...
    document.myform.action = "modify_test_mn.jsp?mnID=<%=test.mnTestID%>";
...
function del_check()
{
	...
	if(noSelect == true)
	{
  	...
  	else
  	{
        	...
        	{
                document.myform.method = "POST";
                document.myform.action = "mn_test_quest_del.jsp";
                document.myform.target="_self";
                document.myform.submit();
        	}
        	else
...
{
	document.myform.method = "POST";
    document.myform.action = "mn_test_quest_add.jsp";
    document.myform.target="_self";
    document.myform.submit();
...
<TABLE cellSpacing=0 cellPadding=0 width=650 border=0>
  ...
  <strong><font color="#3366FF" size="+2" face="黑体">单元测试试卷修改</font></strong>
  <!--begin test -->
  <FORM action=Query_unit_test_mark.jsp method=post name=myform target="_self" id="myform" onSubmit="return CheckForm(this)">
    <TABLE width=100% height="60" border=0 cellPadding=0 cellSpacing=0>
      <TBODY>
        <TR>
          <TD height="75"  align=middle> <table width="600" height="42" border="1" align="center" cellspacing="1" bordercolor="#799AE1" id="AutoNumber3" style="border-collapse: collapse">
              <tr>
                <td height="24" nowrap background="../images/admin_bg_1.gif" bgcolor="#FFFDE8">
                  <div align="center">
                    <table width="100%" border="0">
                      <tr>
                        <td width="35%">&nbsp;</td>
                        <td width="15%"><input name="errDel" type="button" class="s03" id="errDel" value="删 除" border="0" onClick=subform("del")></td>
                        <td width="17%"><input name="errAscRate" type="button" class="s03" id="errAscRate2" value="添 加" border="0" onClick=subform("add")></td>
                        <td width="24%">
			<input name="goback" type="button" class="s03" id="goback"  onClick="gotestpaper()" value="返回"></td>
                        <td width="9%">&nbsp;</td>
                      </tr>
                    </table>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div align="center">(<%=rs.getInt("Mark")%>分)</div></td>
    ...
    <p>
      ...
      <input name="mntestID" type="hidden" id="mntestID" value="<%=test.mnTestID%>">

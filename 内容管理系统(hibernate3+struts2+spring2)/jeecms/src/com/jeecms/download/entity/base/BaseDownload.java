...
public abstract class BaseDownload  implements Serializable {
	...
	private com.jeecms.download.entity.DownLicense license;
	private com.jeecms.download.entity.DownLanguage language;
	...
	/**
	 * Return the value associated with the column: LICENSE_ID
	 */
	public com.jeecms.download.entity.DownLicense getLicense () {
		return license;
	}

	/**
	 * Set the value related to the column: LICENSE_ID
	 * @param license the LICENSE_ID value
	 */
	public void setLicense (com.jeecms.download.entity.DownLicense license) {
	 ...
	 */
	public com.jeecms.download.entity.DownLanguage getLanguage () {
		return language;
	}
	 ...
	 */
	public void setLanguage (com.jeecms.download.entity.DownLanguage language) {

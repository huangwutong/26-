...
/**
 * This is an object that contains data related to the DOWN_LICENSE table.
...
public abstract class BaseDownLicense  implements Serializable {

	public static String REF = "DownLicense";
	 ...
	 */
	public BaseDownLicense (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.download.entity.DownLicense)) return false;
		else {
			com.jeecms.download.entity.DownLicense downLicense = (com.jeecms.download.entity.DownLicense) obj;
			if (null == this.getId() || null == downLicense.getId()) return false;
			else return (this.getId().equals(downLicense.getId()));
		}
	}

...
public class ArticleMngImpl extends JeeCoreManagerImpl<Article> implements
	...
	private void addToLucene(Article bean) {
		luceneSvc.addDoc("", bean.getId(), bean.getUrl(), bean.getTitle(), bean
				.getDescription(), bean.getContent(), bean.getReleaseSysDate(),
				"ARTI", bean.getGroup().getLevel());
	}

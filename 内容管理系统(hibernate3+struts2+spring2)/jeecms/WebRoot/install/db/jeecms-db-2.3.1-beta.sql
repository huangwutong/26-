...
comment = "软件语言（简体中文、繁体中文、英文、多国语言）";

/*==============================================================*/
/* Table: DOWN_LICENSE                                          */
/*==============================================================*/
create table DOWN_LICENSE
(
...
alter table DOWN_DOWNLOAD add constraint FK_DOWNLOAD_LANGUAGE foreign key (LANGUAGE_ID)
      references DOWN_LANGUAGE (LANGUAGE_ID) on delete restrict on update restrict;

alter table DOWN_DOWNLOAD add constraint FK_DOWNLOAD_LICENSE foreign key (LICENSE_ID)
      references DOWN_LICENSE (LICENSE_ID) on delete restrict on update restrict;
...
alter table DOWN_LANGUAGE add constraint FK_DOWNLANGUAGE_WEBSITE foreign key (WEBSITE_ID)
      references CORE_WEBSITE (WEBSITE_ID) on delete restrict on update restrict;

alter table DOWN_LICENSE add constraint FK_DOWNLICENSE_WEBSITE foreign key (WEBSITE_ID)
      references CORE_WEBSITE (WEBSITE_ID) on delete restrict on update restrict;

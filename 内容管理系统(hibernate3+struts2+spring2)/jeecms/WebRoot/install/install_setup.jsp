<%@page contentType="text/html; charset=gbk" language="java" import="com.jeecms.core.util.Install,java.util.*"%>
...
<%
	...
	String dbFileName = "/install/db/jeecms-db-2.3.1-beta.sql";
	String initFileName = "/install/db/jeecms-init-2.3.1-beta.sql";

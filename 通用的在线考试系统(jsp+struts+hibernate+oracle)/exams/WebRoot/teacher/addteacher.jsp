...
<html:form action="/teacher/admin/adddo" method="post" onsubmit="return checkteacherform(this)">
 	<tr>
      <td align="center" bgcolor="94C9E7">用户名</td>
      <td align="left" bgcolor="FFFFFF"><html:text property="username" style="width:200px"/></td>
    </tr>
 	<tr>

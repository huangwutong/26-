...
<html:form action="/teacher/subject/addquestiondo" method="post" onsubmit="return checkquestionform(this)">
<html:hidden property="subjectid"/> 
<table width="450"  border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#3D7BA3">
      <tr>
      ...
      <tr>
		...
		<td align="center" bgcolor="ffffff"><html:multibox property="rightanswers" value="${c}"/></td>      	
      	<td align="left" bgcolor="ffffff"><html:textarea property="options" cols="60" rows="1"/></td>
      </tr> 
      <%}%>                         
</table>  	
<html:submit value="增加" />&nbsp;&nbsp;<html:reset value="重置" />
</html:form>
</center>
<script>
	...
	function checkquestionform(sf){
		var message = "";
		var i = 1;
		if(sf.content.value.length==0||sf.content.value.length>2000){
			message += i+") 题目内容为1-2000个字符\n";
			i++;
		}

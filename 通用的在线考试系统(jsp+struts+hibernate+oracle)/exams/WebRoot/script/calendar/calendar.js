...
write("<table border='0' bgcolor='#7FC16B'>");
write("<TR>");
...
write("<DIV style='background-color:#0F3B01'><table width='100%' border='0'>");
...
write("<B style='color:"+gcBG+";cursor:hand; font-size:12px' onclick='fSetDate(giYear,giMonth,giDay)' onMouseOver='this.style.color=gcToggle' onMouseOut='this.style.color=gcBG'></B>");
write("</td></tr></table>");
write("</TD></TR>");
write("</TABLE></Div>");
}
...
<html>
	...
	<body>
		...
		<div align="left">
			<p>
				<a href="<%=request.getContextPath()%>/jsp/user/seleoutcar.action">查看出车单</a>
			</p>
		</div>
		<p></p>
		...
		<ec:table items="message" var="ucapli" filterable="true"
			...
			<ec:row>
			 <ec:column property="rowcount" cell="rowCount" title="序号" sortable="false" filterable="false"></ec:column>
				...
				<ec:column property="dele" title="派车" sortable="false" filterable="false"
					viewsAllowed="html" style="width: 6%">
					<a href="<c:url value="/ITSMPM/takecar.action?Id=${ucapli.ucapliid}" />">派车</a>
				</ec:column> 
			</ec:row>
		</ec:table>
